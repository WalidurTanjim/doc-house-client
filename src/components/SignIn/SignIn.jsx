                ...
                <div className='border rounded-md p-5 w-full lg:w-[550px]'>
                    ...
                    <form className='mt-5'>
                        ...
                        <div className='password mb-2'>
                            ...
                            <div className="mt-1">
                                <input id="password" name="password" type="password" autoComplete="off" className="block w-full rounded-md py-1.5 border border-gray-300 focus:outline-[#4a817d] shadow-sm" />
                            </div>
                        </div>
